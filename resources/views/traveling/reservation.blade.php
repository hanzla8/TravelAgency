    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="main-button"><a href="{{ route('traveling.about', ['id' => $city->id]) }}">Discover More</a></div>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                  <fieldset>
                      ...
                      <input type="text" name="name" class="Name" placeholder="Ex. Yaar Ghaddar" autocomplete="on" required>
                  </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
              ...
              <div class="col-lg-6">
                <fieldset>
                    ...
                    <input type="date" name="cheak_in_date" class="date" required>
                </fieldset>
              </div>
              <div class="col-lg-12">
                  <fieldset>
                      <label for="chooseDestination" class="form-label">Choose Your Destination</label>
                        <input type="hidden" value="{{ $city->name }}" name="destination" required>
                  </fieldset>
              </div>
              <div class="col-lg-12">
              ...
              <div class="col-lg-12">                        
                  <fieldset>
                    ...
                    @else
                      <h3 class="alert alert-success">Login to make a booking</h3>
                    @endif
